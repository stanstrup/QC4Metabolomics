dir <- c("/data/Cancer studies/DANISH CANCER SOCIETY_big set_plasma_samples")
...
# # Seems to be some tests missing
...
temp <- file.copy(file_tab$to_fix, file_tab$fixed)
all(temp)

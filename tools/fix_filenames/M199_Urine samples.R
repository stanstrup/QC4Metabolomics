dir <- "/data/OPUS studies/M199 - Nordic meals study/M199_urine samples.PRO"

to_fix <- list.files(dir,"\\.mzML$" ,full.names = TRUE, recursive = TRUE)

to_fix <- grep("CALIBRATION|TEST|bad|150810-025|150810-178|150810-232|260510-001|260510-002|260510-003|260510-004", to_fix, value = TRUE, invert = TRUE)

project <- "OPUS-M199-Urine samples"
#date_format <- "%d%m%Y"

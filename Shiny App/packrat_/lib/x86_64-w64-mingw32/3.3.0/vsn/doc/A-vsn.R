### R code from vignette source 'A-vsn.Rnw'
...
###################################################
### code chunk number 4: overv2
###################################################
M = exprs(xnorm)[,1] - exprs(xnorm)[,2]


###################################################
### code chunk number 5: overv3
###################################################
fit = vsn2(kidney)
...
###################################################
### code chunk number 7: nkid-scp1
###################################################
openBitmap("nkid-scp", cols=2)


###################################################
### code chunk number 8: nkid-scp2
###################################################
...
###################################################
### code chunk number 9: nkid-scp3
###################################################
dev.off()


###################################################
### code chunk number 10: nkid-sdmean1
###################################################
meanSdPlot(xnorm, ranks=TRUE)


###################################################
### code chunk number 11: nkid-sdmean2
###################################################
...
###################################################
### code chunk number 16: lym-sdmean
###################################################
meanSdPlot(lym)


###################################################
### code chunk number 17: lym-M
###################################################
iref = seq(1, 15, by=2)
ismp = seq(2, 16, by=2)
...
###################################################
### code chunk number 19: affy2
###################################################
d_rma = rma(Dilution)


###################################################
### code chunk number 20: figaffy1
###################################################
openBitmap("affy", cols=3, rows=1)


###################################################
### code chunk number 21: figaffy2
###################################################
par(pch=".")
ax = c(2, 16)
...
###################################################
### code chunk number 22: figaffy3
###################################################
dev.off()


###################################################
### code chunk number 23: limma
###################################################
require("limma")
...
###################################################
### code chunk number 24: lymNCS
###################################################
lymNCS


###################################################
### code chunk number 25: addmeta
###################################################
vmd = data.frame(
...
###################################################
### code chunk number 30: justvsnwbg
###################################################
...
###################################################
### code chunk number 33: nostrata
###################################################
EsenzaStr = justvsn(lymRG[,1])


###################################################
### code chunk number 34: figstrata1
###################################################
openBitmap("figstrata")


###################################################
### code chunk number 35: figstrata2
###################################################
j = 1L
...
###################################################
### code chunk number 36: figstrata3
###################################################
dev.off()


###################################################
### code chunk number 37: miss1
###################################################
lym2 = lymphoma
nfeat = prod(dim(lym2))
...
###################################################
### code chunk number 41: ref1
###################################################
ref = vsn2(lymphoma[, ismp[1:7]])


###################################################
### code chunk number 42: ref2
###################################################
...
###################################################
### code chunk number 43: ref3
###################################################
fall = vsn2(lymphoma[, ismp])


###################################################
### code chunk number 44: ref4
###################################################
coefficients(f8)[,1,]
coefficients(fall)[,8,]
...
###################################################
### code chunk number 45: figref1
###################################################
openBitmap("figref")


###################################################
### code chunk number 46: figref2
###################################################
...
###################################################
### code chunk number 47: figref3
###################################################
dev.off()


###################################################
### code chunk number 48: hiddenchecks
###################################################
...
###################################################
### code chunk number 49: nkid-calib1
###################################################
coef(fit)[1,,]


###################################################
### code chunk number 50: nkid-calib2
###################################################
bkid = kidney
...
###################################################
### code chunk number 51: nkid-calib3
###################################################
bfit = vsn2(bkid)


###################################################
### code chunk number 52: nkid-calib4
###################################################
...
###################################################
### code chunk number 53: nkid-calib5
###################################################
...
###################################################
### code chunk number 54: nkid-calib6
###################################################
dev.off()
options(oldwarn)
rm(list="oldwarn")
...
###################################################
### code chunk number 56: figqvsn1
###################################################
openBitmap("qvsn", cols=2, rows=1)


###################################################
### code chunk number 57: figqvsn
###################################################
...
###################################################
### code chunk number 58: figqvsn3
###################################################
dev.off()


###################################################
### code chunk number 59: calcshrink
###################################################
log2.na = function(x){
  w = which(x>0)
...
###################################################
### code chunk number 60: figshrink
###################################################
...
###################################################
### code chunk number 63: lymquscp1
###################################################
openBitmap("lymquscp")


###################################################
### code chunk number 64: lymquscp2
###################################################
...
###################################################
### code chunk number 65: lymquscp3
###################################################
dev.off()

dir <- c("/data/DanORC studies/95B Aarhus_plasma samples_Pos_Neg/Plasma Plate 95B Arhus Samples_neg.PRO", "/data/DanORC studies/95B Aarhus_plasma samples_Pos_Neg/Plasma Plate 95B Arhus Samples_pos.PRO")

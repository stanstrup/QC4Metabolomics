...
dir <- "/data/SYSDIET/SysDiet Kati Mouse and Pig tissues biofluids.pro/SysDiet Katti_Mouse tissue and plasma samples_plate I_230910.PRO"

to_fix <- list.files(dir,"\\.mzML$" ,full.names = TRUE, recursive = TRUE)

project <- "SYSDIET-kati-mouse-tissue-plasma"
instrument <- "Qnew"
date_format <- "%d%m%Y"

...
to_fix <- list.files("/data/SYSDIET/Sysdiet multicenter intervention_feaces samples/mzML", full.names = TRUE, recursive = TRUE)
...
sample_list <- "/data/SYSDIET/Sysdiet multicenter intervention_feaces samples/SampleDB/Sysdiet_feces.SPL" %>% 
                gsub(" ","\\\\ ", .) %>% 
